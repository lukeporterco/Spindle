...
public record MinecraftServerLaunchCommand(
    ...
    public MinecraftServerLaunchCommand {
        ...
        serverArgs = List.copyOf(serverArgs == null || serverArgs.isEmpty() ? List.of("nogui") : serverArgs);
    ...
    public static MinecraftServerLaunchCommand simpleJar(
        ...
        List<String> effectiveServerArgs = serverArgs == null || serverArgs.isEmpty() ? List.of("nogui") : List.copyOf(serverArgs);
