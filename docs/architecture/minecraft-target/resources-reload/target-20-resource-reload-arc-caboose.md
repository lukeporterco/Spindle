...
This is a caboose decision analysis pass document for the Minecraft Target Layer. It records what Target-20 adds or decides while preserving the current Minecraft, SteelHook, and public API boundaries.

## Inputs

- Target-16 through Target-19 resource/reload reports.

## Output

- Deterministic `minecraft-resource-reload-arc-decision.json`.

## Capability Added Or Recorded

- Records that the resource/reload arc is complete enough for now.
- Chooses registry bootstrap and content registration as the next concept family.
...
- Does not implement registry behavior, discover registry symbols, design a new SteelHook primitive, implement reload handling, access resources or datapacks, generate data, expose APIs, or imply sandboxing.

## Follow-On Direction

- Target-21 begins registry bootstrap and content registration boundary analysis.
