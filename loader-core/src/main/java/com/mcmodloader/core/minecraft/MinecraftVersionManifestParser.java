...
public final class MinecraftVersionManifestParser {
    public MinecraftVersionManifest parse(String json, String sourceDescription) throws LoaderException {
    ...
    private JsonObject parseObject(String json, String sourceDescription) throws LoaderException {
        try {
            ...
            if (!root.isJsonObject()) {
                throw new LoaderException("Minecraft version manifest must be a JSON object: " + sourceDescription);
            }
            return root.getAsJsonObject();
        } catch (JsonParseException exception) {
            throw new LoaderException("Invalid Minecraft version manifest JSON: " + sourceDescription, exception);
        }
    }
