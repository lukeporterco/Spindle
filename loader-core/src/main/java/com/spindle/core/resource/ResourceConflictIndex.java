package com.spindle.core.resource;
...
public final class ResourceConflictIndex {
  ...
  private ResourceConflictIndex(
      List<ResourceConflict> conflicts, Map<String, Integer> resourceCountByMod) {
  ...
  private static boolean isIgnoredResource(String entryName) {
    return entryName.endsWith(".class")
        ...
        || "loader.mod.json".equals(entryName);
  }
}
