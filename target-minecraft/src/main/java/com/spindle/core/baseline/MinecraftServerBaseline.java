...
public record MinecraftServerBaseline(
    ...
    com.spindle.core.minecraft.MinecraftVersionSelection versionSelection,
    Metadata metadata,
  ...
  public record ServerArtifact(
      String path, String sourceUrl, String sha1, String sha256, Long size, boolean verified) {}
  ...
  public record OfflineReplay(
      boolean attempted, String resultPath, boolean succeeded, int networkCalls) {}
