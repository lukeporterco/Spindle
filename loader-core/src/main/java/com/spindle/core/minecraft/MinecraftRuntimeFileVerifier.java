...
public final class MinecraftRuntimeFileVerifier {
  public Verification verify(Path path, String expectedSha1) throws LoaderException {
    ...
    try {
      ...
      boolean verified =
          expectedSha1 == null || expectedSha1.isBlank() || expectedSha1.equalsIgnoreCase(sha1);
      return new Verification(
          sha1, sha256, size, true, verified, verified ? "verified" : "sha1-mismatch");
  ...
  public record Verification(
      String sha1, String sha256, long size, boolean present, boolean verified, String status) {}
}
