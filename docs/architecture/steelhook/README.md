...
SteelHook 0.2 Target pass documents now begin under `../minecraft-target/steelhook-0.2/`. Target-23 selects the first approved primitive boundary as analysis-only planning input for later contract and transformer generalization work.
